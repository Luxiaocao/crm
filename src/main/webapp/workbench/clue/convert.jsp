...
<script type="text/javascript">
	$(function(){
		...
		//提交市场活动
		$("#sumbmitActivityBtn").click(function(){
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button"  class="btn btn-primary" id="sumbmitActivityBtn">提交</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="create-contact" style="position: relative; left: 40px; height: 35px;">
		新建联系人123：${param.fullname}<%=appellation%>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form action="workbench/clue/convert.do" id="tranForm" method="post">
		  ...
		  <input type="hidden"  name="flag" value="transaction">
